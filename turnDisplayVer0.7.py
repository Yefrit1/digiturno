...
class Digiturno(QMainWindow):
    ...
    def __init__(self):
        ...
        #self.queue = {'A': [1, 5, 10], 'B': [3, 8, 9], 'C': [7, 11], 'D': [2, 4, 13], 'E': [6, 12, 14], 'F': [15], 'G': [16], 'H': [17], 'I': [18]}
    ...
    def init_ui(self):
        ...
        headerLayout.setContentsMargins(0, 20, 20, 20)
        ...
        spanLabel = QLabel("")
        spanLabel.setFixedSize(170, 30)
        self.gridLayout.addWidget(spanLabel, 2, 0)
